...
function cars.calculate_working_cars_per_hour(production_rate, success_rate)
  -- local result = (success_rate/100)*production_rate
  -- return tonumber(string.format("%2f", result))
  
  return success_rate * production_rate / 100
end
...
function cars.calculate_working_cars_per_minute(production_rate, success_rate)
  local result = cars.calculate_working_cars_per_hour(production_rate, success_rate)//60
...
function cars.calculate_cost(cars_count)
  ...
  local total = ((cars_count - rem) * 9500) + (rem * 10000)
